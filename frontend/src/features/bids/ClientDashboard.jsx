                            ...
                            {selectedGig ? (
                                <>
                                    ...
                                    {loadingBids ? (
                                        ...
                                        <div className="glass rounded-xl p-8 text-center border border-gray-200 dark:border-gray-700">
                                        ...
                                        <div className="space-y-4">
                                            {bids.map((bid) => (
                                                <div
                                                    key={bid._id}
                                                    className="glass rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 transition-all"
                                                >
                        ...
                        <div className="p-6 space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
